...
class _CustomTabBarColor {
  final Color unSelectedCardColor = Color.fromARGB(77, 62, 109, 121);
  final Color selectedCardColor = AppColors.appColor;
  final Color selectedTitleColor = Colors.white;
  final Color unSelectedTitleColor = Colors.black;
}
